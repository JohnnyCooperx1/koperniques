...
<div id="foods"  class=" clearfix grid"> 
    <figure class="effect-oscar  wowload fadeInUp">
        <img src= "<c:url value="/images/portfolio/1.jpg"/>"  alt="img01"/>
        <figcaption>
            <h2>Cappuchino</h2>
            <p>Lily likes to play with crayons and pencils<br>
            <a href= "<c:url value="/images/portfolio/1.jpg"/>" title="1" data-gallery>View more</a></p>
        </figcaption>
    </figure>
     <figure class="effect-oscar  wowload fadeInUp">
        <img src=  "<c:url value="/images/portfolio/2.jpg"/>" alt="img01"/>
        <figcaption>
            <h2>Latte</h2>
            <p>Lily likes to play with crayons and pencils<br>
            <a href= "<c:url value="/images/portfolio/2.jpg"/>" title="1" data-gallery>View more</a></p>
        </figcaption>
    </figure>
     <figure class="effect-oscar  wowload fadeInUp">
        <img src= "<c:url value="/images/portfolio/3.jpg"/>" alt="img01"/>
        <figcaption>
            <h2>Ambience</h2>
            <p>Lily likes to play with crayons and pencils<br>
            <a href=  "<c:url value="/images/portfolio/3.jpg"/>" title="1" data-gallery>View more</a></p>
        </figcaption>
    </figure>
     <figure class="effect-oscar  wowload fadeInUp">
        <img src=  "<c:url value="/images/portfolio/4.jpg"/>" alt="img01"/>
        <figcaption>
            <h2>Fruits</h2>
            <p>Lily likes to play with crayons and pencils<br>
            <a href="<c:url value="/images/portfolio/4.jpg"/>" title="1" data-gallery>View more</a></p>
        </figcaption>
    </figure>
     
     <figure class="effect-oscar  wowload fadeInUp">
        <img src="<c:url value="/images/portfolio/5.jpg"/>"  alt="img01"/>
        <figcaption>
            <h2>Breakfast</h2>
            <p>Lily likes to play with crayons and pencils<br>
            <a href= "<c:url value="/images/portfolio/5.jpg"/>" title="1" data-gallery>View more</a></p>
        </figcaption>
    </figure>
    <figure class="effect-oscar  wowload fadeInUp">
        <img src="<c:url value="/images/portfolio/6.jpg"/>" alt="img01"/>
        <figcaption>
            <h2>Kitchen</h2>
            <p>Lily likes to play with crayons and pencils<br>
            <a href= "<c:url value="/images/portfolio/6.jpg"/>" title="1" data-gallery>View more</a></p>
        </figcaption>
    </figure>
...
<div id="partners" class="container spacer ">
  ...
  <div class="clearfix">    
    ...
    <div class="carousel-inner">  
      ...
      <div class="animated slideInLeft col-xs-2"><img alt="portfolio" src= "<c:url value="/images/team/1.jpg"/>" width="100" class="img-circle img-responsive"></div>
      <div  class="col-xs-10">
      ...
      <div class="animated slideInLeft col-xs-2"><img alt="portfolio" src="<c:url value="/images/team/2.jpg"/>"   width="100" class="img-circle img-responsive"></div>
      <div  class="col-xs-10">
      ...
      <div class="item  animated bounceInRight row">
      <div class="animated slideInLeft  col-xs-2"><img alt="portfolio" src="<c:url value="/images/team/3.jpg"/>" width="100" class="img-circle img-responsive"></div>
      <div  class="col-xs-10">
...
<div class="row grid team  wowload fadeInUpBig">	
	...
	<figure class="effect-chico">
        <img src= "<c:url value="/images/team/8.jpg"/>" alt="img01" class="img-responsive" />
        <figcaption>
    ...
    <div class=" col-sm-3 col-xs-6">
	<figure class="effect-chico">
        <img src="<c:url value="/images/team/10.jpg"/>" alt="img01"/>
        <figcaption>            
    ...
    <div class=" col-sm-3 col-xs-6">
	<figure class="effect-chico">
        <img src="<c:url value="/images/team/12.jpg"/>" alt="img01"/>
        <figcaption>
    ...
    <div class=" col-sm-3 col-xs-6">
	<figure class="effect-chico">
        <img src="<c:url value="/images/team/17.jpg"/>" alt="img01"/>
        <figcaption>
            <p><b>Barbara Husto</b><br>Asst Chef</p>
        </figcaption>
    </figure>
...
<!-- jquery -->
<script src="<c:url value="/assets/jquery.js"/>"></script>

<!-- wow script -->
<script src= "<c:url value="/assets/wow/wow.min.js"/>" ></script>


<!-- boostrap -->
<script src="<c:url value="/assets/bootstrap/js/bootstrap.js"/>" type="text/javascript" ></script>

<!-- jquery mobile -->
<script src="<c:url value="/assets/mobile/touchSwipe.min.js"/>" ></script>
<script src="<c:url value="/assets/respond/respond.js"/>" ></script>

<!-- gallery -->
<script src="<c:url value="/assets/gallery/jquery.blueimp-gallery.min.js"/>" ></script>
